...
<div class="alert alert-danger" id="alerts" hidden="true">
	<p id="error"></p>
</div>
<!-- cambio para la demo -->
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<label for="rfc">{l s='Delegation' mod='blockfactura'}</label>
						</div>
					</div>
				</div>
	...
	<div class="bloque-preview">
		...
		<div class="row">
			<div class="col-md-2 col-md-offset-8 col-xs-12">
				<button style="float: right;" id="btn-back" type="button" name="button" class="btn btn-default btn-block">{l s='Back' mod='blockfactura'}</button>
			</div>
			<div class="col-md-2 col-xs-12">
				<button style="float: right;" id="btn-invoice" type="button" name="button" class="btn btn-info btn-block">{l s='CREATE INVOICE' mod='blockfactura'}</button>
			</div>
		</div>
		</div>
</div>
